<?php
// OpenAI o4-mini Analysis - Fast and cost-effective
...
Keep response under 500 words for efficiency.";
    ...
    if (!empty($OPENAI_API_KEY) && !empty($media_content)) {
        ...
        $ai_analysis = "⚠️ o1-mini analysis unavailable. API key: " . (empty($OPENAI_API_KEY) ? "missing" : "set") . ", Media: " . count($media_content) . " items";
        $cost = 0;
    }

    // Format the analysis
    $analysis_summary = "🤖 OpenAI o4-mini Analysis (Fast & Efficient)\n\n";
